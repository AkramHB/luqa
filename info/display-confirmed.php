...
<body style="background-color: #ffffff;" dir="rtl">
    ...
    <?php
            ...
            $sql = "SELECT * FROM confirm LIMIT $items OFFSET $offset";
            $result = $MySQL_Handle->query($sql);

            if ($result->num_rows > 0) {

                echo "<div class = 'container text-center mt-5'><table class = 'table table-hover table-responsive text-center'>
                    <thead class='thead-light'><tr><th scope='col'>ID #</th><th scope='col'>الاسم</th><th scope='col'>رقم الهوية</th><th scope='col'>رقم الجوال</th><th scope='col'>البريد الالكتروني</th></tr></thead>";
     ...
     <div class = "container my-5">
         <div class = "row justify-content-between">
            <div class = "col-3 order-2">                     
                <a class = "btn btn-default btn-success" style = "background-color: #466653; color: #d8b92b;" href="display-confirmed.php?page=<?php echo $page + 1; ?>">الصفحة التالية</a>
            </div>
            <div class = "col-3 order-1">
                <?php if ($page != 1) { ?>
                    <a class = "btn btn-default btn-success" style = "background-color: #466653; color: #d8b92b;" href="display-confirmed.php?page=<?php echo $page - 1; ?>">الصفحة السابقة</a>
                <?php } ?>
            </div>
        </div>
     </div> 
